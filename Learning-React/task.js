...
// Func1
function findOne(filterVar, value) {
    return SNEAKERS.find(sneaker => sneaker[filterVar] === value);
  }
  console.log(findOne("colorway", "Pine Green"));
  console.log("*********************************")

  
// Func2
function findAll(filterVar, value) {
    return SNEAKERS.filter(sneaker => sneaker[filterVar] === value);
  }
  console.log("*********************************")
  console.log(findAll("brand", "Nike"));
